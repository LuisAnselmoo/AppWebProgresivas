export function headerMenu() {
  ...
  // --- Dropdown normal (pantalla grande) ---
        ...
        if (!mobileProfileLinks) {
          ...
          if (verMensajesMobile) {
            verMensajesMobile.addEventListener("click", (e) => {
              e.preventDefault();
              menuToggle.click(); // cerrar menú hamburguesa
              document.getElementById("verMensajes")?.click(); // simula click en el original
            });
          }
          ...
          if (btnLogoutMobile) {
            btnLogoutMobile.addEventListener("click", (e) => {
              e.preventDefault();
              menuToggle.click(); // cierra menú
              document.getElementById("btnLogout")?.click(); // reutiliza el listener existente
            });
          }
        }
      } else {
        // Cierra el menú → muestra el perfil original
